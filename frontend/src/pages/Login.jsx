...
const Login = () => {
  ...
  const submitHandler = async event => {
    ...
    try {
      ...
      console.log(result.data, "user data after dispatch");
        ...
        <form className="py-4 md:py-0" onSubmit={submitHandler}>
          ...
          <div className="mb-5">
            ...
            <div className="mt-7 py-8">
              <button type="submit" className="w-full bg-orange-500 text-white text-[18px] leading-[30px] rounded-lg px-4 py-3">{ loading ? <SyncLoader size={25} color="#fff" /> : "Entrar"}</button>
            </div>
